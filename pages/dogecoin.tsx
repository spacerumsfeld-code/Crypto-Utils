  ...
  >
    ...
    >
      ...
      >
        ...
        <Heading>Dogecoin</Heading>
      </Flex>
      <Container border="1px solid white" centerContent>
        <Text fontSize="lg" border="1px solid white" padding="1em">
          Hello World. Welcome to the exciting world of Dogecoin. Introduced in
          2009, Dogecoin is a digital cryptocurrency that uses stuff to do cool
          things.
        </Text>
      </Container>
    </Flex>
...
export async function getStaticProps() {
  const tweets = await utils.getTweets('Dogecoin');
